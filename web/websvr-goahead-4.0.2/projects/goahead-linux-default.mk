...
clean:
	...
	rm -f "$(BUILD)/obj/Account.o"
	rm -f "$(BUILD)/obj/Diagnose.o"
	rm -f "$(BUILD)/obj/login.o"
...
$(BUILD)/obj/Account.o: \
    src/suyi/Account.c $(DEPS_19)
	@echo '   [Compile] $(BUILD)/obj/Account.o'
	$(CC) -c -o $(BUILD)/obj/Account.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/suyi/Account.c

$(BUILD)/obj/Diagnose.o: \
    src/suyi/Diagnose.c $(DEPS_19)
	@echo '   [Compile] $(BUILD)/obj/Diagnose.o'
	$(CC) -c -o $(BUILD)/obj/Diagnose.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/suyi/Diagnose.c

$(BUILD)/obj/login.o: \
    src/suyi/login.c $(DEPS_19)
	@echo '   [Compile] $(BUILD)/obj/login.o'
	$(CC) -c -o $(BUILD)/obj/login.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/suyi/login.c

$(BUILD)/obj/settingDtu.o: \
    src/suyi/settingDtu.c $(DEPS_19)
	@echo '   [Compile] $(BUILD)/obj/settingDtu.o'
	$(CC) -c -o $(BUILD)/obj/settingDtu.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/suyi/settingDtu.c

$(BUILD)/obj/settingLAN.o: \
    src/suyi/settingLAN.c $(DEPS_19)
	@echo '   [Compile] $(BUILD)/obj/settingLAN.o'
	$(CC) -c -o $(BUILD)/obj/settingLAN.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/suyi/settingLAN.c

$(BUILD)/obj/settingLTE.o: \
    src/suyi/settingLTE.c $(DEPS_19)
...
$(BUILD)/obj/settingSecurity.o: \
	...
	$(CC) -c -o $(BUILD)/obj/settingSecurity.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/suyi/settingSecurity.c

$(BUILD)/obj/settingWH.o: \
    src/suyi/settingWH.c $(DEPS_19)
	@echo '   [Compile] $(BUILD)/obj/settingWH.o'
	$(CC) -c -o $(BUILD)/obj/settingWH.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/suyi/settingWH.c

$(BUILD)/obj/Version.o: \
    src/suyi/Version.c $(DEPS_19)
	@echo '   [Compile] $(BUILD)/obj/Version.o'
	$(CC) -c -o $(BUILD)/obj/Version.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/suyi/Version.c

$(BUILD)/obj/RunningStatus.o: \
    src/suyi/RunningStatus.c $(DEPS_19)
	@echo '   [Compile] $(BUILD)/obj/RunningStatus.o'
	$(CC) -c -o $(BUILD)/obj/RunningStatus.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/suyi/RunningStatus.c
...
DEPS_36 += $(BUILD)/obj/Account.o
DEPS_36 += $(BUILD)/obj/Diagnose.o
DEPS_36 += $(BUILD)/obj/login.o
